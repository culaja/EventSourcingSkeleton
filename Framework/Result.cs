 ...
 namespace Framework
{
    ...
    internal sealed class ResultCommonLogic : ResultCommonLogic<Error>
    {
        [DebuggerStepThrough]
        public static ResultCommonLogic Create(bool isFailure, Error error)
        {
            if (isFailure)
            {
                if (error == null)
        ...
        public ResultCommonLogic(bool isFailure, Error error) : base(isFailure, error)
        {
        }
    }
